    ...
    public function inventory_markers()
    {
        ...
        $markers = $preMarkers->map(function ($inventario) {
            ...
            return new MapMarkerAsset([
                ...
                'lat' => $inventario->adjusted_lat ? $inventario->adjusted_lat : (float)$inventario->latitud,
                'lng' => $inventario->adjusted_lng ? $inventario->adjusted_lng : (float)$inventario->longitud,
                'created_at' => now(),
                'updated_at' => now()
            ]);
        });
