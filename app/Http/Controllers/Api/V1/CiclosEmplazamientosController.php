...
class CiclosEmplazamientosController extends Controller
{
     ...
     * @return  \Illuminate\Http\Response
     */
    public function showAssets(int $ciclo, int $emplazamiento, Request $request)
    {
        ...
        $queryBuilder = $emplaN2Obj->inv_activos()->where('inv_inventario.id_ciclo', $cicloObj->idCiclo);
