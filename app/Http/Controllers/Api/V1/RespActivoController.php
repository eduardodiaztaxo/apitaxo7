...
class RespActivoController extends Controller
{
    ...
    protected function rules(){
        ...
        return [
            'tratamiento'       => 'integer|min:1', 
            'sociedad'          => 'max:6',  
            'fecha'             => 'max:64',  
            'numero_af'         => 'max:15',  
            'sub_numero'        => 'max:2',  
            'centro_costo'      => 'max:12|exists:centro_costos,codigoCliente',  
            'localizacion'      => 'integer|min:1|exists:ubicaciones_geograficas,codigoCliente',  
            'fecha_compra'      => 'date|date_format:d-m-Y',  
            'descripcion'       => 'max:255',  
            'etiqueta'          => 'max:64',  
            'serie'             => 'max:64',   
            'marca'             => 'max:64',   
