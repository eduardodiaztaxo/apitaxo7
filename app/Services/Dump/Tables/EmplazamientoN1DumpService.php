...
class EmplazamientoN1DumpService implements DumpSQLiteInterface
{
    ...
    public function runFromController(): void
    {
        ...
        $response = $zonasEmplaCtrl->CycleCatsNivel1($this->cycle);
    ...
    public function createTable(): void
    {
        ...
        $this->pdo->exec("
            CREATE TABLE IF NOT EXISTS emplazamientosN1 (
