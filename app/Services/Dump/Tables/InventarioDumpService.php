    ...
    public function createTable(): void
    {
        ...
        $this->pdo->exec("
            CREATE TABLE IF NOT EXISTS inventario (
                ...
                idUbicacionN3 TEXT,
                codigoUbicacionN4 TEXT,
                codigoUbicacionN5 TEXT,
                codigoUbicacionN6 TEXT,
    ...
    public function insert(array|AnonymousResourceCollection $invt): void
    {
        ...
        foreach ($invt as $i) {
            ...
            $stmt->execute([
                ...
                ':codigoUbicacionN4' => $i->codigoUbicacionN4 ?? '',
                ':codigoUbicacionN5' => $i->codigoUbicacionN5 ?? '',
                ':codigoUbicacionN6' => $i->codigoUbicacionN6 ?? '',
