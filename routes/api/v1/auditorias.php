...
Route::middleware(['auth:sanctum', 'switch.database'])->prefix('v2/auditoria')->group(function () {
    ...
    Route::get('ciclos/{ciclo}/puntos/{punto}/codigo/${codigo}/subnivel/${subnivel}/sublevels-with-assets-contain-group-family', [CiclosAuditoriaUbicacionesController::class, 'showByCycleAndGrupFamily']);
    ...
    Route::get('ciclos/{ciclo}/puntos/{punto}/codigo/{codigo}/subnivel/{subnivel}/assets-contain-group-family', [CiclosAuditoriaUbicacionesController::class, 'showAssetsByUbicacionAndSublevel']);
